...
$helper->set_description(
	sprintf(
		__( '%2$sReduces image file sizes%3$s without loosing quality. %1$sBy compressing your images our speed up your website and boost your SEO.', 'upload-max-file-size' ),
		'<br>', '<strong>', '</strong>'
	)
);
?>
<div class="card single-link imagify">
	<div class="link-infos">
		...
		<span class="link-infos-txt">
			...
			<p><?php printf( __( 'Status : %1$s', 'upload-max-file-size' ), $helper->get_status_text( $status ) ); ?></p>
		</span>
	</div>
