...
$helper->set_icon( '<img src="' . UMFS_PLUGIN_URL . 'assets/img/logo-rocket.jpg" alt="">' );
...
$helper->set_button_text(
	array(
		...
		'installed'     => esc_html__( 'Activate WP Rocket', 'upload-max-file-size' ),
		'not_installed' => esc_html__( 'Get WP Rocket', 'upload-max-file-size' ),
	)
);
?>
