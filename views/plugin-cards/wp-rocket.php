 ...
 */
	...
	$helper->set_description(
		sprintf(
			__( 'Integrate more than 80&#x25; of web performance good practices automatically to %1$sreduce your website\'s loading time.%2$s', 'upload-max-file-size' ),
			'<strong>', '</strong>'
		)
	);
?>
<div class="card single-link wp-rocket">
	...
	<?php else: ?>
		<a class="link-btn button-primary <?php echo esc_attr( $helper->get_status() ); ?>" href="https://wp-rocket.me/?utm_source=wp_plugin&utm_medium=rocket_file_size">
			<?php echo $helper->get_button_text(); ?>
		</a>
	<?php endif; ?>
</div>
